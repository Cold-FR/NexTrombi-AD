...
export default function ConfirmDeleteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 p-4 backdrop-blur-sm">
      <div className="animate-in fade-in zoom-in-95 relative w-full max-w-sm rounded-xl border border-gray-100 bg-white shadow-2xl duration-200 dark:border-gray-700 dark:bg-gray-800">
        {/* En-tête */}
