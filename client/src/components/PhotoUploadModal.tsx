...
export default function PhotoUploadModal({ isOpen, onClose, user, onSave }: PhotoUploadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 p-4 backdrop-blur-sm transition-opacity">
      <div className="animate-in fade-in zoom-in-95 relative w-full max-w-md rounded-xl border border-gray-100 bg-white shadow-2xl duration-200 dark:border-gray-700 dark:bg-gray-800">
